...
/** A short, all-caps section divider (e.g. "PLAYLISTS"). */
...
export default function ClientSidebar({
  ...
  // Playlists are always visible — they're the heart of the library. The
  // layout preference only toggles the inline numbered liked-tracks list.
    ...
    >
      ...
      <div className="flex min-h-0 flex-1 flex-col rounded-xl bg-[var(--color-sidebar)] pt-3">
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-0.5 overflow-y-auto px-2 pb-3">
          {/* Tu música — liked songs, plus the optional numbered list. */}
          {!collapsed ? (
            <SectionLabel>
          ...
          {/* Playlists — always shown (collapsed shows icons only). Clicking
              opens the playlist's page in the main view. */}
