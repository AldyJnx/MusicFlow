...
class _$AuthUserImpl implements _AuthUser {
  ...
  @override
  String toString() {
    return 'AuthUser(id: $id, email: $email, username: $username, role: $role, isPremium: $isPremium, avatar: $avatar)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, email, username, role, isPremium, avatar);
