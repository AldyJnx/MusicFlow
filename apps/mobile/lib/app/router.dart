...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: AppRoutes.playlists, builder: (_, __) => const PlaylistScreen()),
      ...
      GoRoute(path: AppRoutes.nowPlaying, builder: (_, __) => const NowPlayingScreen()),
      GoRoute(path: AppRoutes.equalizer, builder: (_, __) => const EqualizerScreen()),
      GoRoute(path: AppRoutes.aiAgent, builder: (_, __) => const AiChatScreen()),
    ],
  );
});
